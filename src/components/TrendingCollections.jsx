              ...
              <div key={id} className={display}>
                ...
                <div className="flex items-center justify-between gap-[0.94rem] mb-[0.94rem]">
                  <img
                    src={NFTs[0]}
                    alt="Rat NFT"
                    className="w-1/3 h-[5.9rem]"
                  />
                  <img src={NFTs[1]} alt="" className="w-1/3 h-[5.9rem]" />
                  <div className="bg-primaryPurple rounded-[1.25rem]  flex items-center justify-center w-1/3 h-[5.9rem]">
                    <p className="text-base font-bold font-SpaceMono leading-[140%] px-[0.94rem] py-[2rem]">
                      1025+
                    </p>
                  </div>
                </div>
                <div>
                  ...
                  <div className="flex items-center gap-[0.75rem]">
                    ...
                    <p className="text-base leading-[140%]">{owner.username}</p>
                  </div>
                </div>
              </div>
            );
