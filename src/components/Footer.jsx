        ...
        <div className="pb-8 border-b-[2px] border-gray-500 lg:grid lg:grid-cols-2 xl:grid-cols-3">
          <div className="mb-8">
            <div className="mr-auto flex items-center gap-x-3 mb-6">
              ...
              <h3 className="font-SpaceMono font-bold text-xl">
                NFT Marketplace
              </h3>
            </div>
            <p className="w-11/12 text-gray-300 mb-5">
          ...
          <div>
            <h3 className="font-SpaceMono font-bold text-xl mb-4">
              Join our weekly digest
            </h3>
            <p className="text-gray-300 w-11/12 mb-6">
