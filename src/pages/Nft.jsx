    ...
    <>
        <MainLayout>
          {/* hero section */}
            ...
            <section className="py-[2.5rem] lg:py-[5rem] bg-[#2B2B2B]">
              <div className=" w-[84.188%] md:w[81.1676%] lg:w-[82%] mx-auto  relative">
                <h2 className="text-white md:text-[1.75rem] lg:text-[2.375rem] font-WorkSans font-semibold text-left">
                More from this artist
                </h2>
                <button className=" w-full md:w-fit absolute bottom-0 md:top-0 md:right-0 px-[3.12rem] rounded-[1.25rem] items-center border-2 border-[#A259FF] flex h-[3.75rem] hover:border-white ">
                ...
                {/* NFT Cards */}
                <div className="grid grid-flow-col-dense pb-[3.88rem] md:pb-[0] gap-x-[1.88rem] sm:gap-y-[3.75rem] mt-[3.75rem] max-[500px]:grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 h-auto">
                    {
